...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.comparison': 'Event Comparison',
    ...
    'input.loading': 'Processing shipment data...',
    ...
    'alerts.tabDifferences': 'Differences',
    'alerts.tabDetails': 'Details',
    'alerts.noAlerts': 'No alerts detected between the two shipments.',
    'alerts.infoSection': 'Information',
    'alerts.warningSection': 'Warnings',
    'alerts.info.actualEventAtPol': 'Actual {event} event detected at Port of Loading{details}',
    'alerts.info.actualEventAtPod': 'Actual {event} event detected at Port of Discharge{details}',
    'alerts.warning.estimatedVdChangeAtPol':
      'Estimated Vessel Departure at POL changed from {previous} to {current} ({difference})',
    'alerts.warning.estimatedVaChangeAtPod':
      'Estimated Vessel Arrival at POD changed from {previous} to {current} ({difference})',
    'alerts.warning.transitionPortsChanged': 'Number of transhipment ports changed: {primary} → {secondary}',
    'alerts.direction.delayed': 'delayed',
    'alerts.direction.advanced': 'advanced',
    'alerts.detail.time': 'Time: {time}',
    'alerts.detail.location': 'Location: {location}',
    'alerts.detail.conveyance': 'Vessel: {conveyance}',
    'alerts.units.hoursShort': 'hrs',
    ...
    'timeline.dwellTime': 'Dwell: {hours} hrs',
    'timeline.dwellAlert': 'Extended dwell time at port',
    'eta.later': 'later than estimated',
    'eta.earlier': 'earlier than estimated',
    'eta.varianceLabel': '{hours} hrs {direction}',
    ...
    'ai.delayAdjust': '+{hours}h adj',
    'milestone.title': 'Shipment Milestones',
    'milestone.gateIn': 'Gate In (POL)',
    'milestone.loaded': 'Loaded (POL)',
    'milestone.vesselDeparture': 'Vessel Departure (POL)',
    'milestone.transitArr': 'Arrival at {port}',
    'milestone.transitDep': 'Departure from {port}',
    'milestone.vesselArrival': 'Vessel Arrival (POD)',
    'milestone.unloaded': 'Unloaded (POD)',
    'milestone.gateOut': 'Gate Out (POD)',
    'milestone.origin': 'Origin',
    'milestone.transit': 'Transit',
  ...
  'zh-Hant': {
    ...
    'parser.containerStatusFormat': '{status} - {timeType}',
    'alerts.tabAlerts': '警報',
    'alerts.tabDifferences': '差異',
    'alerts.tabDetails': '詳情',
    'alerts.noAlerts': '兩筆貨運資料未偵測到警報。',
    'alerts.infoSection': '資訊',
    'alerts.warningSection': '警告',
    'alerts.info.actualEventAtPol': '裝貨港偵測到實際 {event} 事件{details}',
    'alerts.info.actualEventAtPod': '卸貨港偵測到實際 {event} 事件{details}',
    'alerts.warning.estimatedVdChangeAtPol':
      '裝貨港預計船舶離港時間由 {previous} 變更為 {current}（{difference}）',
    'alerts.warning.estimatedVaChangeAtPod':
      '卸貨港預計船舶到港時間由 {previous} 變更為 {current}（{difference}）',
    'alerts.warning.transitionPortsChanged': '轉運港數量變更：{primary} → {secondary}',
    'alerts.direction.delayed': '延遲',
    'alerts.direction.advanced': '提前',
    'alerts.detail.time': '時間：{time}',
    'alerts.detail.location': '地點：{location}',
    'alerts.detail.conveyance': '船舶：{conveyance}',
    'alerts.units.hoursShort': '小時',
    ...
    'timeline.dwellTime': '停留：{hours} 小時',
    'timeline.dwellAlert': '港口停留時間較長',
    'eta.later': '晚於預計',
    'eta.earlier': '早於預計',
    'eta.varianceLabel': '{hours} 小時{direction}',
    'ai.predicted': 'AI 預測',
    'ai.delayRisk': '延遲風險：',
    'ai.risk.low': '低風險',
    'ai.risk.medium': '中等風險',
    'ai.risk.high': '高風險',
    'ai.confidence': '信心：{value}%',
    'ai.modelVersion': '模型：{version}',
    'ai.delayAdjust': '+{hours}小時 調整',
    'milestone.title': '貨運里程碑',
    'milestone.gateIn': '閘口進場（POL）',
    'milestone.loaded': '裝船（POL）',
    'milestone.vesselDeparture': '船舶離港（POL）',
    'milestone.transitArr': '抵達 {port}',
    'milestone.transitDep': '離開 {port}',
    'milestone.vesselArrival': '船舶到港（POD）',
    'milestone.unloaded': '卸船（POD）',
    'milestone.gateOut': '閘口出場（POD）',
    'milestone.origin': '起運',
    'milestone.transit': '轉運',
    'milestone.destination': '目的',
  },
};
