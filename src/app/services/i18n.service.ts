...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'alerts.info.actualEventAtPol': 'Actual {event} event detected at Port of Loading',
    'alerts.info.actualEventAtPod': 'Actual {event} event detected at Port of Discharge',
    'alerts.warning.estimatedVdChangeAtPol': 'Estimated Vessel Departure at POL changed by {hours} hours ({direction})',
    'alerts.warning.estimatedVaChangeAtPod': 'Estimated Vessel Arrival at POD changed by {hours} hours ({direction})',
  ...
  'zh-Hant': {
    ...
    'alerts.info.actualEventAtPol': '裝貨港偵測到實際 {event} 事件',
    'alerts.info.actualEventAtPod': '卸貨港偵測到實際 {event} 事件',
    'alerts.warning.estimatedVdChangeAtPol': '裝貨港預計船舶離港時間變更 {hours} 小時（{direction}）',
    'alerts.warning.estimatedVaChangeAtPod': '卸貨港預計船舶到港時間變更 {hours} 小時（{direction}）',
