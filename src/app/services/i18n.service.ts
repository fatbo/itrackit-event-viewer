...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'history.title': 'Shipment History',
    'history.toggleAria': 'Toggle shipment history',
    'history.empty': 'No shipment history yet.',
    'history.viewedAt': 'Viewed',
    'history.load': 'Load',
    'history.delete': 'Delete',
    'history.clearAll': 'Clear History',
    'history.loadAria': 'Load shipment from history',
    'history.deleteAria': 'Delete shipment history entry',
    'history.clearAria': 'Clear all shipment history',
    'history.container': 'Container',
    'history.containerUnavailable': 'Container: N/A',
    'history.from': 'From',
    'history.to': 'to',
    'history.locationUnknown': 'Unknown',
    'history.unknownShipment': 'Unknown shipment',
    ...
    'routeMap.noLocations': 'No route locations are available for this shipment.',
    'routeMap.noMappedLocations': 'Locations were found, but no coordinates are available to plot.',
    'routeMap.unmappedLocations': 'Unmapped locations',
    'routeMap.noEventsAtLocation': 'No event details at this location.',
    'routeMap.timeUnknown': 'Unknown time',
    'routeMap.delay': '{value} hrs {direction}',
    'routeMap.delayLate': 'late',
    'routeMap.delayEarly': 'early',
  ...
  'zh-Hant': {
    ...
    'history.title': '貨運歷程',
    'history.toggleAria': '切換貨運歷程',
    'history.empty': '目前沒有貨運歷程。',
    'history.viewedAt': '檢視時間',
    'history.load': '載入',
    'history.delete': '刪除',
    'history.clearAll': '清除歷程',
    'history.loadAria': '從歷程載入貨運',
    'history.deleteAria': '刪除貨運歷程項目',
    'history.clearAria': '清除所有貨運歷程',
    'history.container': '貨櫃',
    'history.containerUnavailable': '貨櫃：無',
    'history.from': '從',
    'history.to': '到',
    'history.locationUnknown': '未知',
    'history.unknownShipment': '未知貨運',
    'summary.title': '貨運摘要',
    ...
    'routeMap.title': '航線地圖',
    'routeMap.noLocations': '此貨運沒有可用的航線地點資料。',
    'routeMap.noMappedLocations': '已找到地點，但缺少可繪製的座標。',
    'routeMap.unmappedLocations': '未對應座標的地點',
    'routeMap.noEventsAtLocation': '此地點沒有事件詳情。',
    'routeMap.timeUnknown': '時間未知',
    'routeMap.delay': '{value} 小時{direction}',
    'routeMap.delayLate': '延遲',
    'routeMap.delayEarly': '提前',
